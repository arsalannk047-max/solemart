...
// Only the small ribbon tag cycles through these accent colors — the card's own
// background stays fixed/consistent for every product so the grid never looks mismatched.
...
export default function ProductCard({ product }) {
  ...
  return (
    ...
    >
      {/* small brand ribbon — only this cycles color, card body stays consistent */}
      ...
      {/* image sits on the SAME light background as the card — no more mismatched tint */}
      <div className="relative aspect-square flex items-center justify-center p-6 pt-10 bg-surfacealt">
        <img
